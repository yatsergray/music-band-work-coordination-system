...
public interface BandSongVersionService {
    ...
    BandSongVersionDTO addBandSongVersion(BandSongVersionEditableDTO bandSongVersionEditableDTO) throws NoSuchBandException, NoSuchSongException, NoSuchSongStructureException, NoSuchKeyException;

    Optional<BandSongVersionDTO> getBandSongVersionById(UUID id);

    List<BandSongVersionDTO> getAllBandSongVersions();

    BandSongVersionDTO modifyBandSongVersionById(UUID id, BandSongVersionEditableDTO bandSongVersionEditableDTO) throws NoSuchBandSongVersionException, NoSuchBandException, NoSuchSongException, NoSuchSongStructureException, NoSuchKeyException;
